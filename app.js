...
const express = require('express'); //express npm installed
const hbs = require('hbs');         //hbs nmp installed
const path = require('path');       //path npm installed
...
// set the port to which the server will be listening
